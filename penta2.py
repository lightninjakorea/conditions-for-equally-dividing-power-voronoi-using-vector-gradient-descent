...
for epoch in range(epochs):
    ...
    # P 업데이트
    def similarity_feedback_P3P1() :
        global P1, P2, P3, CD_per
        inter=finding_intersection(CD_per, P3, P1-P2, P1)
        d_P3=calculate_distance(inter, P3)
        d_P1=calculate_distance(inter, P1)
        #같은 부호로
        P3=translate_along_byvector(P3, CD_per, -(gradient_D-gradient_B)*d_P3*learning_rate)
        P1=translate_along_byvector(P1, (P2-P1), -(gradient_D-gradient_B)*d_P1*learning_rate)

    def similarity_feedback_P2P1() :
        global P1, P2, P3, DE_per
        inter=finding_intersection(DE_per, P2, P1-P3, P1)
        d_P1=calculate_distance(inter, P1)
        d_P2=calculate_distance(inter, P2)
        #같은 부호로?
        P1=translate_along_byvector(P1, (P3-P1), -(gradient_D-gradient_B)*d_P1*learning_rate)
        P2=translate_along_byvector(P2, EA_per, (gradient_D-gradient_B)*d_P2*learning_rate)
    similarity_feedback_P2P1()
    similarity_feedback_P3P1()
    P2 = translate_along_vector(P2, P1, gradient_E*learning_rate*5)
    P3 = translate_along_vector(P3, P1, gradient_C*learning_rate*5)
